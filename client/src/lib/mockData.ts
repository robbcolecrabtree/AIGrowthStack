...
export interface Software {
  ...
  /** Optional latest news/update callout (e.g. May 1 Update) */
  latestNews?: string;
...
const base = (overrides: Partial<Software>): Software => {
  ...
  return {
    ...
    lastUpdated: overrides.lastUpdated ?? "2026-05-01",
...
export const mockSoftware: Software[] = [
  base({
    ...
    latestNews: "May 1, 2026 Update: AdCreative.ai rolls out Version 7, introducing Fashion Photoshoot AI for professional e-commerce imagery and Storytelling Ads that auto-generate conversion-focused videos from a simple URL.",
    faqs: [
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: The Jasper + Surfer SEO integration now supports one-click competitive content audits and real-time semantic keyword scoring directly within the Jasper command center.",
    faqs: [
  ...
  base({
    ...
    featured: true,
    description:
      "Creator Plan ROI focus: 100,000 characters/month, Professional Voice Cloning, full commercial rights, and API access—the tier most marketers pick after Free/Starter without paying for Pro volume they may not need. The 2026 stack also includes Free (10K chars) and Starter ($5) for tests and light use; we break down every cap so you never burn credits blind.",
    latestNews:
      "May 1, 2026: Creator Plan remains the default pick for growth teams—100K chars/mo, Pro-level cloning, commercial license, and API. Step up to Pro only when you consistently clear ~400K+ characters or need priority throughput.",
    creatorPlanHighlight:
      "The Creator Plan is where most teams land: 100,000 characters per month, Professional Voice Cloning, full commercial rights, and API access—enough runway for ads, explainers, and localization without Pro’s 500K price jump. Flash v2.5 halves per-character cost when you need extra headroom. Updated May 1, 2026.",
  ...
  base({
    ...
    cardAccent: "#FF0050",
    featured: true,
    metaTitle: "Synthesia AI Video: 2026 Ultra-Realistic Avatars & Pricing",
    metaDescription: "In 2026, Synthesia delivers ultra-realistic AI avatars, faster video rendering, and multi-language generation—training, onboarding, and explainers without a studio.",
    latestNews: "May 1, 2026 Update: Synthesia releases new ultra-realistic Avatars and significantly faster rendering times, so teams can ship polished presenter-style video even quicker.",
    faqs: [
      { question: "How much is Synthesia in May 1, 2026?", answer: "Starter is $18/mo (10 min video/mo); Creator is $64/mo (30 min video/mo) billed annually." },
  ...
  base({
    ...
    badge: "Best Value",
    featured: true,
    metaTitle: "Gamma AI Presentations: 2026 Brand Templates & Pro Pricing",
    metaDescription: "In 2026, Gamma pairs custom brand templates with faster AI presentation generation—slide decks, docs, and webpages from a prompt. Founders and growth teams ship polished decks in minutes.",
    latestNews: "May 1, 2026 Update: Gamma adds new custom brand templates and improves AI presentation generation speed so teams get on-brand decks and docs even faster.",
    faqs: [
  ...
  base({
    ...
    cardAccent: "#5B21B6",
    metaTitle: "Browse AI Web Scraping: 2026 Auto-Adapting Agents & Pricing",
    metaDescription: "2026 auto-healing scrapers that adapt to website UI changes instantly without breaking. No-code web data extraction—competitor pricing, leads, and monitoring.",
    latestNews: "May 1, 2026 Update: Browse AI launches Auto-Healing Agents, allowing scrapers to dynamically adjust to website redesigns and layout shifts without requiring manual retraining.",
    faqs: [
      { question: "What is the cost of Browse AI in May 1, 2026?", answer: "Personal starts at $48/mo; Professional is $87/mo (usage-based)." },
  ...
  base({
    ...
    cardAccent: "#18BFFF",
    faqs: [
      { question: "What does Airtable cost in May 1, 2026?", answer: "Free tier available; Plus from $20/user/mo; Pro from $45/user/mo with AI fields and advanced automations." },
  ...
  base({
    ...
    cardAccent: "#FF5C00",
    faqs: [
      { question: "What does Originality.ai cost in May 1, 2026?", answer: "Pay-as-you-go from $14 for 2,000 credits; bulk plans available for teams." },
  ...
  base({
    ...
    badge: "Editor's Choice",
    faqs: [
      { question: "Is Make.com still free in May 1, 2026?", answer: "Yes, the Free plan offers 1,000 operations/month and a 15-minute run interval." },
  ...
  base({
    ...
    cardAccent: "#4F46E5",
    faqs: [
      { question: "What is the pricing for Reclaim.ai in May 1, 2026?", answer: "Lite is free, Starter is $10/mo (8-week scheduling), and Business is $15/mo (12-week scheduling)." },
  ...
  base({
    ...
    metaTitle: "Murf AI 2026: Hyper-Realistic Voiceovers & TTS Pricing",
    metaDescription: "Murf in 2026: hyper-realistic AI voiceovers for video and podcasts, Falcon-class latency for agents, and advanced pronunciation controls—studio-quality TTS at scale.",
    latestNews: "May 1, 2026 Update: Murf adds 20 new hyper-realistic voiceover styles and improves advanced pronunciation controls for clearer, more natural reads on technical and branded terms.",
    faqs: [
      { question: "What is Murf AI pricing in May 1, 2026?", answer: "Starter from $19/mo; Pro from $39/mo with commercial rights and advanced voice features." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: HeyGen improves voice translation accuracy for more natural localized audio and delivers faster video rendering speeds across avatar and translation workflows.",
    faqs: [
      { question: "What does HeyGen cost in May 1, 2026?", answer: "Creator from $29/mo; Business from $89/mo with more minutes and team features." },
  ...
  base({
    ...
    cardAccent: "#000000",
    metaTitle: "Notion AI 2026: Document Q&A, Databases & Workspace Pricing",
    metaDescription: "Notion AI in 2026: smarter Q&A over your documents, enhanced database autofill, and writing help inside your workspace—summaries, drafts, and answers where your team already works.",
    latestNews: "May 1, 2026 Update: Notion AI improves Q&A document querying for faster, more accurate answers from your pages, plus enhanced database autofill to populate properties from context.",
    faqs: [
      { question: "What does Notion AI cost in May 1, 2026?", answer: "Notion AI add-on is $10/user/mo; included in Plus and Business plans." },
  ...
  base({
    ...
    cardAccent: "#FF7A59",
    faqs: [
      { question: "Is HubSpot AI included in HubSpot in May 1, 2026?", answer: "Yes, AI features are built into CRM, Marketing, and Sales hubs; availability varies by plan." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: InVideo expands its stock media library and improves AI script generation so marketers can draft stronger narratives and pair them with more footage options.",
    faqs: [
      { question: "What does InVideo AI cost in May 1, 2026?", answer: "Plans from $20/mo; Plus and Max tiers offer more credits and premium templates." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: Introduced Voice Mode for real-time interaction. Now powered by CoreWeave NVIDIA GB200 clusters for significantly lower search latency.",
    faqs: [
  ...
  base({
    ...
    cardAccent: "#22C55E",
    faqs: [
      { question: "Is Copy.ai free in May 1, 2026?", answer: "Yes, a free tier exists; Pro from $49/mo for unlimited words and team features." },
  ...
  base({
    ...
    cardAccent: "#10B981",
    faqs: [
      { question: "What does Fireflies.ai cost in May 1, 2026?", answer: "Free tier available; Pro from $10/user/mo; Business adds CRM sync and team analytics." },
  ...
  base({
    ...
    cardAccent: "#00C4CC",
    faqs: [
      { question: "What does Canva Magic cost in May 1, 2026?", answer: "Canva Pro from $12.99/mo includes Magic Design, text-to-image, and AI editing tools." },
  ...
  base({
    ...
    cardAccent: "#111827",
    faqs: [
      { question: "What does Writesonic cost in May 1, 2026?", answer: "Plans from $13/mo; Unlimited and Enterprise tiers for higher volume." },
  ...
  base({
    ...
    cardAccent: "#2D2D2D",
    faqs: [
      { question: "What are the Midjourney pricing tiers in May 1, 2026?", answer: "Basic is $10/mo; Standard is $30/mo (includes Relax Mode); Pro is $60/mo (includes Stealth Mode)." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: Descript rolls out their next-gen AI video engine, featuring instant automated multicam editing and enhanced Studio Sound that clones your voice for seamless audio corrections.",
  ...
  base({
    ...
    cardAccent: "#6366F1",
    faqs: [
      { question: "What does Frase cost in May 1, 2026?", answer: "Solo from $15/mo; Basic from $45/mo; Team plans for collaboration." },
  ...
  base({
    ...
    cardAccent: "#20B2AA",
    faqs: [
      { question: "What does Otter.ai cost in May 1, 2026?", answer: "Pro from $10/user/mo; Business adds team features and integrations." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: New documentation reveals Claude's 'Computer Use' capability is significantly outperforming competitors in browser-based form automation and complex data entry.",
    faqs: [
      { question: "What does Claude 3.5 Sonnet cost in May 1, 2026?", answer: "Claude Pro is $20/mo; API pricing varies by usage and model tier." },
  ...
  base({
    ...
    cardAccent: "#00D4FF",
    faqs: [
      { question: "What does Runway Gen-3 cost in May 1, 2026?", answer: "Standard from $15/mo; Pro and Unlimited tiers add more credits and advanced features." },
  ...
  base({
    ...
    cardAccent: "#6366F1",
    faqs: [
      { question: "What does Clay cost in May 1, 2026?", answer: "Clay starts at $149/mo; scale plans for higher enrichment and AI agent usage." },
  ...
  base({
    ...
    cardAccent: "#000000",
    faqs: [
      { question: "Is v0 free in May 1, 2026?", answer: "v0 offers a free tier; Pro adds more generations and commercial usage." },
  ...
  base({
    ...
    cardAccent: "#FA5D19",
    faqs: [
      { question: "What does Firecrawl cost in May 1, 2026?", answer: "Hobby from $19/mo; Standard and Scale for higher crawl volume and API usage." },
  ...
  base({
    ...
    cardAccent: "#3B82F6",
    faqs: [
      { question: "What does Chatbase cost in May 1, 2026?", answer: "Free tier available; Starter from $19/mo; Growth and Scale for higher limits." },
  ...
  base({
    ...
    faqs: [
      { question: "What does ActiveCampaign cost in May 1, 2026?", answer: "Lite from $15/mo; Plus and Pro add AI agents, predictive sending, and CRM." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: Now in General Availability. Early data shows a 2.3x increase in meetings booked and 36% higher adoption rates for teams using agentic workflows.",
    faqs: [
      { question: "How accurate is Apollo.io lead data in 2026?", answer: "As of May 1, 2026, Apollo uses waterfall enrichment—cross-referencing multiple data providers—to achieve less than 3% bounce rates on Verified emails. The AI assistant leverages 250+ data points per lead for personalized outreach sequences. Enrichment quality has improved significantly for intent and technographic accuracy." },
      { question: "Which CRM integrations does Apollo.io support in May 1, 2026?", answer: "Apollo.io integrates with Salesforce, HubSpot, Pipedrive, Outreach, and most major CRMs. May 1, 2026 features include bidirectional sync, custom field mapping, and automated lead scoring. The platform also connects to email tools, LinkedIn, and enrichment partners like Clearbit." },
  ...
  base({
    ...
    cardAccent: "#6366F1",
    faqs: [
      { question: "What does Lindy.ai cost in May 1, 2026?", answer: "Free tier available; Pro from $19/mo per agent; scale plans for teams." },
  ...
  base({
    ...
    cardAccent: "#6366F1",
    faqs: [
      { question: "What does Search Atlas cost in May 1, 2026?", answer: "Plans from $99/mo; includes OTTO SEO automation and LLM Visibility tracking." },
  ...
  base({
    ...
    faqs: [
      { question: "What does GoHighLevel cost in May 1, 2026?", answer: "Agency Starter from $97/mo; unlimited sub-accounts for white-label agencies." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 update: Zapier Central now supports multi-step reasoning and persistent memory across 5,000+ app integrations without requiring traditional Zap setups.",
    faqs: [
      { question: "Is Zapier Central free as of May 1, 2026?", answer: "Yes, a free tier exists; paid plans add more AI agent tasks and app connections." },
  ...
  base({
    ...
    faqs: [
      { question: "Is Activepieces free in May 1, 2026?", answer: "Yes, open-source with a generous cloud free tier; no per-task pricing." },
  ...
  base({
    ...
    faqs: [
      { question: "What does AiSDR cost in May 1, 2026?", answer: "Plans scale with contacts and sequences; tailored for SDR-style outbound volume." },
  ...
  base({
    ...
    reviewContent: `<p>Amplemarket sits at the end of the May 1, 2026 sales stack, closing the loop on leads generated by <a href="/product/apollo/">Apollo</a> and personalized via <a href="/product/mindstudio/">MindStudio</a>. Duo AI pairs human reps with AI for reply handling and high-conversion closing sequences.</p>`,
  ...
  base({
    ...
    faqs: [
      { question: "What does Consensus cost in May 1, 2026?", answer: "Free tier available; Premium adds unlimited searches and export; plans scale for teams." },
  ...
  base({
    ...
    faqs: [
      { question: "What does Laxis cost in May 1, 2026?", answer: "Plans from $8/user/mo; Business adds CRM sync and team analytics." },
  ...
  base({
    ...
    latestNews: "May 1, 2026 Update: L3 Bootcamp enters Week 2. Focus shifts to 'State Management'—builders are using 'State Snapshots' to debug variable logic in multi-step AI agents.",
  ...
  base({
    ...
    faqs: [
      { question: "What does QuillBot cost in May 1, 2026?", answer: "Free tier available; Premium from $4.95/mo adds plagiarism checker and unlimited paraphrasing." },
  ...
  base({
    ...
    faqs: [
      { question: "How much is Tidio Lyro AI in May 1, 2026?", answer: "Lyro AI starts at $39/mo as an add-on for 100 conversations." },
  ...
  base({
    ...
    metaTitle: "Unbounce Landing Pages: 2026 AI Generation & Pricing",
    metaDescription: "Generative UI capabilities and real-time predictive conversion scoring. AI-powered landing pages—create, test, and optimize high-converting pages at scale.",
    latestNews: "May 1, 2026 Update: Unbounce rolls out Generative UI, allowing marketers to instantly spawn fully designed, brand-compliant landing page variants from a single text prompt.",
    faqs: [
      { question: "What does Unbounce cost in May 1, 2026?", answer: "Essential from $74/mo; Optimize and Scale add Smart Traffic and AI features." },
  ...
  base({
    ...
    faqs: [
      { question: "What does Blackbox AI cost in May 1, 2026?", answer: "Free tier available; Pro adds unlimited autocomplete and code search in IDE." },
