...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    metaTitle: "Zapier AI Agents: The 2026 Growth Engineer's Manual (Updated April)",
    metaDescription:
      "Deploy AI Agents that actually work. A 2026 guide to Zapier growth loops for engineers. Updated April 7.",
    featured: true,
    content: `
  ...
  },
  {
    ...
    title: "ElevenLabs Creator Plan Pricing 2026: Is It Actually Worth It?",
    excerpt:
      "ElevenLabs Creator vs. Pro: which tier saves money and credits in 2026? Voice cloning, character limits, credit math, and when Pro actually pays off.",
    category: "Audio & Voice",
    author: "AI Growth Stack Team",
    ...
    readTime: "8 min read",
    featuredToolIds: ["elevenlabs", "heygen"],
    metaTitle: "STOP: Don't Buy ElevenLabs Until You See This (April 2026 Pricing)",
    metaDescription:
      "Don't waste money on the wrong ElevenLabs plan. We broke down the hidden credit costs and ROI for the Creator vs Pro plans, updated for April 13, 2026.",
    content: `
