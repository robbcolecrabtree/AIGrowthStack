...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "8 min read",
    featuredToolIds: ["elevenlabs", "heygen"],
    metaTitle: "ElevenLabs Creator Plan Pricing 2026: Is It Actually Worth It?",
    metaDescription:
      "Does the ElevenLabs Creator Plan actually save you money in 2026? Compare the Creator vs. Pro plan ROI. Updated April 7 with the latest credit costs and hidden limits.",
    content: `
