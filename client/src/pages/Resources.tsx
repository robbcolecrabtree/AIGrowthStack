          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {blueprints.map((blueprint) => {
                ...
                const isFeaturedMay2026 = blueprint.id === "automated-sales-machine";
                return (
                  <Link
                    key={blueprint.id}
                    href={blueprint.ctaHref}
                    className={`group flex flex-col bg-card rounded-2xl border overflow-hidden hover:shadow-lg hover:shadow-primary/5 hover:border-primary/50 transition-all duration-200 hover:-translate-y-1 no-underline ${isFeaturedMay2026 ? "border-primary/40 ring-1 ring-primary/20" : "border-border"}`}
                  >
